...
class Matakuliah extends Model
{
    ...
    protected $fillable = [
        DB::select(['D.nama_matakuliah as D.nama_matakuliah','E.nama_kelas as E.nama_kelas','B.nama_dosen as B.nama_dosen','C.semester as C.semester']);
             ->where('A.id_dosen', '=', B.id_dosen);
