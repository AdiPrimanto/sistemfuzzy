...
<head>
    ...
    <!-- Bootstrap core CSS-->
    <link href="{secure_secure_{asset('backend/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Custom fonts for this template-->
    <link href="{{secure_secure_asset('backend/vendor/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
    <!-- Page level plugin CSS-->
    <link href="{{secure_secure_asset('backend/vendor/datatables/dataTables.bootstrap4.css')}}" rel="stylesheet">
    <!-- Custom styles for this template-->
    <link href="{{secure_secure_asset('backend/css/sb-admin.css')}}" rel="stylesheet">
</head>
