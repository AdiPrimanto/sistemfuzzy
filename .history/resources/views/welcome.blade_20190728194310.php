...
<head>
    ...
    <link href="{{secure_asset('frontend/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
    ...
    <!-- Plugin CSS -->
    <link href="{{secure_asset('frontend/vendor/magnific-popup/magnific-popup.css')}}" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="{{secure_asset('frontend/css/creative.min.css')}}" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src="{{secure_asset('frontend/vendor/scrollreveal/scrollreveal.min.js')}}"></script>
    <script src="{{secure_asset('frontend/vendor/magnific-popup/jquery.magnific-popup.min.js')}}"></script>

    <!-- Custom scripts for this template -->
    <script src="{{secure_asset('frontend/js/creative.min.js')}}"></script>
