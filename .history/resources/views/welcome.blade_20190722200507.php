...
<head>
    ...
    <link href="{{secure_
secure_
secure_asset('frontend/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    {{-- <link href="{{secure_asset('frontend/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet"> --}}

    <!-- Custom fonts for this template -->
    <link href="{{secure_
secure_
secure_asset('frontend/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
    ...
    <link href="{{secure_
secure_
secure_asset('frontend/vendor/magnific-popup/magnific-popup.css')}}" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="{{secure_
secure_
secure_asset('frontend/css/creative.min.css')}}" rel="stylesheet">
